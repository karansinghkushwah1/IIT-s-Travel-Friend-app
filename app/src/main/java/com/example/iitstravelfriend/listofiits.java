...
//This class is used when user clicked on first button
//There we used list view feature to make list of elements and then display them on next page
public class listofiits extends AppCompatActivity {
    ListView listView;
    String listofiitname[] = {"IIT Bhilai","IIT Bhubaneswar","IIT Bombay","IIT Delhi","IIT Dhanbad","IIT Dharwad","IIT Gandhinagar","IIT Goa","IIT Guwahati","IIT Hyderabad","IIT Indore","IIT Jammu","IIT Jodhpur","IIT Kanpur","IIT Kharagpur","IIT Madras","IIT Mandi","IIT Palakkad","IIT Patna","IIT Roorkee","IIT Ropar","IIT Tirupati","IIT (BHU) Varanasi"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listofiits);
        //Create a list view below for IIT name list
        listView = findViewById(R.id.iitnamelistview);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(listofiits.this, Addressbyiitname.class  );
